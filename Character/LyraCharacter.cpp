...
const FName ALyraCharacter::StatSetName = TEXT("StatSet");
	...
	: Super(ObjectInitializer.SetDefaultSubobjectClass<ULyraCharacterMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	...
	StatSet = ObjectInitializer.CreateDefaultSubobject<ULyraStatSet>(this, StatSetName);
}
...
void ALyraCharacter::OnAbilitySystemInitialized()
{
	...
	LyraASC->SetReplicationMode(EGameplayEffectReplicationMode::Full);
