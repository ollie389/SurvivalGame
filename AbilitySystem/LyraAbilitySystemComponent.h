...
//#include "../Plugins/EnhancedInput/Source/EnhancedInput/Public/EnhancedInputComponent.h" //@Game-Change: For enhanced input 

#include "LyraAbilitySystemComponent.generated.h"

//@Game-Change: struct required for enhanced input ability system
USTRUCT()
...
protected:
	...
	//@Game-Change: %%%%%%%%%%%%%%%%% Enhanced gameplay ability system below which allows abilities to be added at runtime  %%%%%%%%%%%%%%%%
public:
	UFUNCTION(BlueprintCallable, Category = "Enhanced Input Abilities")
	void SetInputBinding(class UInputAction* InputAction, FGameplayAbilitySpecHandle AbilityHandle);
...
private:
	...
	UPROPERTY(transient)
	ULyraInputComponent* InputComponent;
};
